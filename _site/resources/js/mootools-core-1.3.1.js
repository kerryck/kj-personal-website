...
web build:
 - http://mootools.net/core/aaa6cef0dfa37a04e8e98de8025ab04b

packager build:
 - packager build Core/Element.Style
...
k[j]={};k.borderWidth[i]=k[j][i]=g[i]="@px";k.borderStyle[f]=k[j][f]=g[f]="@";k.borderColor[h]=k[j][h]=g[h]="rgb(@, @, @)";});}).call(this);
